...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "3147391d946bb4b6c68edd901f2add6ac1f31f8c"
  WORKING_DIRECTORY "C:/Users/LENOVO/Desktop/Progetto_Raffinamento/externals/Main_Source/eigen3"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "3147391d946bb4b6c68edd901f2add6ac1f31f8c")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("3147391d946bb4b6c68edd901f2add6ac1f31f8c" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/3147391d946bb4b6c68edd901f2add6ac1f31f8c")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/LENOVO/Desktop/Progetto_Raffinamento/externals/Main_Source/eigen3'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/LENOVO/Desktop/Progetto_Raffinamento/externals/Main_Source/eigen3'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

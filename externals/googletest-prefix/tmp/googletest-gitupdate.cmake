...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "e2239ee6043f73722e7aa812a459f54a28552929"
  WORKING_DIRECTORY "C:/Users/LENOVO/Desktop/Progetto_Raffinamento/externals/Main_Source/googletest"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "e2239ee6043f73722e7aa812a459f54a28552929")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("e2239ee6043f73722e7aa812a459f54a28552929" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/e2239ee6043f73722e7aa812a459f54a28552929")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/LENOVO/Desktop/Progetto_Raffinamento/externals/Main_Source/googletest'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/LENOVO/Desktop/Progetto_Raffinamento/externals/Main_Source/googletest'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
